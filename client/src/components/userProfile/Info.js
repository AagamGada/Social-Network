...
const Info = () => {
  ...
  async function getParticularUser() {
    try {
      ...
      const { data } = await axios.get(`/Social-Hunt/api/user/particularUser/${userId}`);
      setUser(data);
    } catch (err) {
      console.log(err);
    }
  ...
  const handleFollow = async () => {
    try {
      const userId = params.userId;
      await axios.put(`/Social-Hunt/api/user/follow`, { _id: userId });
      getParticularUser();
    } catch (err) {
      console.log(err);
    }
  ...
  const handleUnFollow = async () => {
    try {
      const userId = params.userId;
      await axios.put(`/Social-Hunt/api/user/unfollow`, { _id: userId });
      getParticularUser();
    } catch (err) {
      console.log(err);
    }
